(function () {
    function gen_selector() {
        ...
        arrow.src = "/2010/ocw/images/idselector/arrow.gif";
    ...
    btn.id = '__idselector_button';
        ...
        back.src = "/2010/ocw/images/idselector/arrow_white_back.png";

        var forward = pdoc.createElement('img');
        forward.style.verticalAlign = "middle"; forward.style.cursor = "pointer";
        forward.src = "/2010/ocw/images/idselector/arrow_white_forward.png";
        ...
        function Cell(grid, idx) {
            ...
            icon.src = provider ? ('/2010/ocw/images/idselector/' + provider.icon) :
                '/2010/ocw/images/idselector/openid.ico';
        ...
        _.select = function (cell) {
            ...
            if (cell.idx > -1) {
                ...
                if (provider["openid2"] && !provider["openid1"]) {
                    ...
                    nameTb.style.backgroundImage = 'url(/2010/ocw/images/idselector/' + provider.icon + ')';
                    oidTb.value = provider.url_prefix + "username" +
                        provider.url_suffix;
                    nameTb.value = "username";
                }
                btnIcn.src = '/2010/ocw/images/idselector/' + provider.icon;
            } else {
                nameLabel.style.visibility = 'hidden';
                nameTb.style.visibility = 'hidden';
                btnIcn.src = '/2010/ocw/images/idselector/openid.ico';
            }
        }
